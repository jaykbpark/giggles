...
class TranscriptProcessor:
    ...
    def process_audio(self, audio_bytes, tags):
        ...
        prompt = f"Given the following InputPrompt, generate at most 3 tags that describe the transcript, matching where possible with the tags: {tags_string}. If the prompt is over 300 characters condense it with minimal loss of context. Return in the format where 'tags' are a list and 'prompt' is a string (either condensed or original), in JSON format. InputPrompt: {transcription_text}"
